...
`claude-mcp-server-minimal` is a hexagonal / DDD-lite Python application. Three layers,
...
`from claude_mcp_server_minimal.infrastructure` line in it, and never should.
