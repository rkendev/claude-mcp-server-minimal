...
[`src/claude_mcp_server_minimal/application/ports.py`](../../../src/claude_mcp_server_minimal/application/ports.py).
...
cp .claude/skills/add-adapter/_adapter_template.py \
   src/claude_mcp_server_minimal/infrastructure/<vendor>_adapter.py
```
...
Edit `src/claude_mcp_server_minimal/infrastructure/settings.py`:
