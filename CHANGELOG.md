...
`copier copy gh:rkendev/claude-mcp-server-minimal my-new-project` — `v0.1.0`'s
...
- **Domain layer** (`src/claude_mcp_server_minimal/domain/`) — frozen Pydantic
...
- **Application layer** (`src/claude_mcp_server_minimal/application/`) — `@runtime_checkable`
  ...
  immediately.
- **Infrastructure adapters** (`src/claude_mcp_server_minimal/infrastructure/`) —
...
[Unreleased]: https://github.com/rkendev/claude-mcp-server-minimal/compare/v0.5.0...HEAD
[0.5.0]: https://github.com/rkendev/claude-mcp-server-minimal/releases/tag/v0.5.0
[0.4.0]: https://github.com/rkendev/claude-mcp-server-minimal/releases/tag/v0.4.0
[0.3.1]: https://github.com/rkendev/claude-mcp-server-minimal/releases/tag/v0.3.1
[0.3.0]: https://github.com/rkendev/claude-mcp-server-minimal/releases/tag/v0.3.0
[0.2.0]: https://github.com/rkendev/claude-mcp-server-minimal/releases/tag/v0.2.0
