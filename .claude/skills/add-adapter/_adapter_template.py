...
`src/claude_mcp_server_minimal/infrastructure/<vendor>_adapter.py` and do the
...
`src/claude_mcp_server_minimal/infrastructure/anthropic_adapter.py`). Keep
...
from claude_mcp_server_minimal.domain.errors import (
    LLMContentError,
    LLMPermanentError,
    LLMTransientError,
)
from claude_mcp_server_minimal.domain.llm import LLMResponse, LLMTier
